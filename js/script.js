...
(function () {
	...
	$(function () {
		...
		function initCircleBg( swiper ) {
			...
			swiper.decor.el.innerHTML = '<div class="swiper-decorative-circle" style="left:'+swiper.decor.circle.centerX+100+'px;top:'+swiper.decor.circle.centerY+'px;width:'+(swiper.decor.circle.radius*2-300)+'px;height:'+(swiper.decor.circle.radius*2)+'px"></div>';
			...
			swiper.on( 'resize', function () {
				swiper.decor.circle = calcCircle( swiper );
				swiper.decor.circleEl.setAttribute( 'style', 'left:'+swiper.decor.circle.centerX+100+'px;top:'+swiper.decor.circle.centerY+'px;width:'+(swiper.decor.circle.radius*2-300)+'px;height:'+(swiper.decor.circle.radius*2)+'px' );
			});
